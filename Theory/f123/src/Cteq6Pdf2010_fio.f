C============================================================================
C     Modified: 2 June 2011: FIO: put file in "PDS" sub-directory
C============================================================================
...
C                                                    (Cteq6.5S)  30 - 34
          write(nn,'(I2)') Iset
          Tablefile=dir//Flnm(7)//'s+'//nn(2:2)//'.pds'
