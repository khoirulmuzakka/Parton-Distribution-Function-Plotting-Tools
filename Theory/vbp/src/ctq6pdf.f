C============================================================================
C                CTEQ Parton Distribution Functions: "Strange" version
...
C --------------------------
C Special sets for strangeness study:
C --------------------------
C  11    CTEQ6A   Class A                 0.118     326   226    cteq6a.pds
C  12    CTEQ6B   Class B                 0.118     326   226    cteq6b.pds
C  13    CTEQ6C   Class C                 0.118     326   226    cteq6c.pds
C  14    CTEQ6B+  Large [S-]              0.118     326   226    cteq6b+.pds
C  15    CTEQ6B-  Negative [S-]           0.118     326   226    cteq6b-.pds
C ============================================================================
...
C                                     Only reset on first call of this routine
